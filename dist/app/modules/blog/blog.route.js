...
// update blog==>
router.patch('/:id', (0, checkAuth_1.default)('admin'), multer_upload_1.default.single('coverImage'), (0, validateRequest_1.default)(blog_validation_1.updateBlogValidationSchema, 'coverImage'), blog_controller_1.BlogControllers.updateBlog);
// delete blog==>
